...
/***/ function(module, exports, __webpack_require__) {
	...
	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // Notes:
	...
	exports.default = _react2.default.createClass({
		...
		getDefaultProps: function getDefaultProps() {
			...
			return {
				...
				breakpoint: 480,
				icon: _react2.default.createElement('img', { className: 'toggleImg', style: { height: '4em', padding: '0.5em', float: 'right' }, src: _icon2.default }),
				narrowChildren: {
					float: 'right',
					clear: 'both',
					textAlign: 'right'
				...
				wideChild: (_wideChild = {
					// margin: '2em',
					color: '#fff',
					marginRight: '1.5em'
				}, _defineProperty(_wideChild, 'color', '#fff'), _defineProperty(_wideChild, 'textDecoration', 'none'), _defineProperty(_wideChild, 'fontSize', '1.3em'), _wideChild)
			};
		},
		...
		render: function render() {
			...
			var childrenWithPropsNarrow = _react2.default.Children.map(this.props.children, function (child) {
				return _react2.default.cloneElement(child, { style: _this.props.narrowChild, className: 'narrowChild' });
			});
			// Adds props to the individual link elements on larger screens
			var childrenWithPropsWide = _react2.default.Children.map(this.props.children, function (child) {
				return _react2.default.cloneElement(child, { style: _this.props.wideChild, className: 'wideChild' });
			});
			...
			if (this.state.width < parseInt(this.props.breakpoint)) {
				...
				if (this.state.linksVisible) {
					links = _react2.default.createElement(
						'div',
						{ className: 'narrowChildren', style: this.props.narrowChildren },
				...
				return _react2.default.createElement(
					'div',
					{ className: 'toggleContainer', onClick: this.toggleChildren },
			...
			return _react2.default.createElement(
				'div',
				{ className: 'wideChildren', style: this.props.wideChildren },
